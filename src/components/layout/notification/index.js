...
import { ReactComponent as NotificationBooking } from "assets/icons/notification-booking.svg";
import { ReactComponent as NotificationMessage } from "assets/icons/notification-message.svg";
import { ClearAllButton } from "components/general/button";

const NotificationPane = ({ className, onClose }) => {
  const { notificationItems, handleSetNotificationItems } = HomeStore;
