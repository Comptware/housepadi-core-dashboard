...
const DashboardLayout = ({ children }) => {
  ...
  return (
    <div className="w-screen min-h-screen h-screen flex flex-grow flex-col relative">
      ...
      <footer className="flex flex-row justify-between items-center w-full py-4 fixed left-0 right-0 bottom-0 border-t-1/2 border-grey-border z-[99] h-[70px] bg-white">
