...
const Utilities = observer(() => {
  const { amenities, rules, allowances } = ListingStore;

  const containerRef = useRef(null);
  const tabs = [
    {
      title: "Amenities",
      content: <AllUtilities data={amenities} type="amenity" />,
    },
    {
      title: "Allowances",
      content: <AllUtilities data={allowances} type="allowance" />,
    },
    {
      title: "Rules",
      content: <AllUtilities data={rules} type="rule" />,
    },
  ];
