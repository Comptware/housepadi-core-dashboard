...
import Overview from "./one";
import ChatSection from "./chatSection";

const NewListingHome = observer(() => {
  ...
  return (
    <div className="flex flex-col justify-start items-start h-full w-full">
      <div className="flex flex-col lg:flex-row justify-start items-start h-full w-full mb-24 relative">
        ...
        <div className="flex flex-col basis-[100%] md:basis-[40%] justify-start items-start h-full w-full space-y-7">
